...
function dwz($url,$type){
		...
		switch($type){
			...
			case 3:
			$html = file_get_contents("http://ff.371178.vip/index.php/index/api/add?&username=admin2112811&key=1w7i3Tc5brwE3ly&url=" . $url);
			...
			break;
			case 11:
			$url2 = file_get_contents("http://tools.aeink.com/tools/dwz/urldwz.php?api=urlcn&longurl=" . $url);
			$json = json_decode($url2, true);
			$url2 = $json['ae_url'];
			break;
			case 12:
			$url2 = file_get_contents("http://yy.gongju.at/?a=addon&m=wxdwz&token=557971b67b4a1803b782789aee204ef0&long=" . $url);
			$json = json_decode($url2, true);
			$url2 = $json['short'];
			break;
			default:
