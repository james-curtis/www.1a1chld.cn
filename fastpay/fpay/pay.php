...
<h4>请按提示付款 不能付多 不能付少 </h4>
<h4>支付成功后 请等待3-6秒 自动跳转</h4>
<div class="qr"></div>
<h6>订单倒计时 过期后请勿支付:<span class="exprie_time" id="time"></span></h6>
<h4>如付款错误 金额将在72小时退回</h4>
...
$(document).ready(function(){
        ...
        $(".qr").html(data.qr_img);
				...
				var str="请付款<span style='color:#eaee0c;font-size:20px;font-weight: bold;padding: 0 5px;'>"+data.total_fee+"元</span> 否则无法播放";
				if(data.fixed_ma<1){
					layer.msg(str, {
				    time: 20000, //20s后自动关闭
						shade: [0.8, '#fff'],
