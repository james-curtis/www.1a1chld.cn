...
class MySql
{
    ...
    function Open()
    {
		...
		{
            $this->DisplayError('无法使用数据库,检查数据库是否存在,请手动建立数据库,或数据库编码是否和配置文件设置一致,配置文件在二维码系统/inc/config.php</br>如果配置文件 $db_charset = utf8 那么数据库编码必须是utf8,如果数据库是GB2132则配置文件改成gb2132;');
			exit();
        }
