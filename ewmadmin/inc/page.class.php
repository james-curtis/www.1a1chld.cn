	...
	function GetList()
	{
		...
		else
		{
			...
			if($this->page > 1)
			{
				...
				if($cfg_isreurl == 'Y' && !isset($keyword))
				{
					$pagetxt .= '<a href="'.$nowurl.'-1.html" title="第一页">&nbsp;&nbsp;第一页&nbsp;&nbsp;</a>';
					$pagetxt .= '<a href="'.$nowurl.'-'.$previous.'.html" title="上一页">&nbsp;&nbsp;上一页&nbsp;&nbsp;</a>';
				}
				else
				{
					$pagetxt .= '<a href="'.$nowurl.'page=1" title="第一页">>&nbsp;&nbsp;第一页&nbsp;&nbsp;</a>';
					$pagetxt .= '<a href="'.$nowurl.'page='.$previous.'" title="上一页">&nbsp;&nbsp;上一页&nbsp;&nbsp;</a>';
				}
			}
			else
			{
				$pagetxt .= '<a href="javascript:;" title="已是第一页">&nbsp;&nbsp;已是第一页&nbsp;&nbsp;</a>';
				$pagetxt .= '<a href="javascript:;" title="已是第一页">&nbsp;&nbsp;已是第一页&nbsp;&nbsp;</a>';
			}
			...
			if($this->totalpage < 10)
			{
				for($i=1; $i <= $this->totalpage; $i++)
				{
					if($this->page == $i)
					{
						$pagetxt .= '<a href="javascript:;" class="on">第'.$i.'页</a>&nbsp;';
					}
					else
					{
						//伪静态设置
						if($cfg_isreurl == 'Y' && !isset($keyword))
						{
							$pagetxt .= '<a href="'.$nowurl.'-'.$i.'.html" class="num" title="第 '.$i.' 页">第'.$i.'页</a>&nbsp;&nbsp;';
						}
						else
						{
							$pagetxt .= '<a href="'.$nowurl.'page='.$i.'" class="num" title="第 '.$i.' 页">第'.$i.'页</a>&nbsp;&nbsp;';
						}
					}
				}
			}
			else
			{
				...
				for($i=$m; $i<=$b; $i++)
				{
					if($this->page == $i)
					{
						$pagetxt .= '<a href="'.$nowurl.'page='.$i.'" class="on">第'.$i.'页</a>&nbsp;';
					}
					else
					{
						//伪静态设置
			...
			if($this->page < $this->totalpage)
			{
				   ...
				   !isset($keyword))
				{
					...
					$pagetxt .= '<a href="'.$nowurl.'-'.$this->totalpage.'.html" title="最后一页">&nbsp;&nbsp;最后一页</a>';
				}
				else
				{
					$pagetxt .= '<a href="'.$nowurl.'page='.$next.'" title="下一页">&nbsp;&nbsp;下一页</a>';
					$pagetxt .= '<a href="'.$nowurl.'page='.$this->totalpage.'" title="最后一页">&nbsp;&nbsp;最后一页</a>';
				}
			}
			else
			{
				$pagetxt .= '<a href="javascript:;" title="已是最后一页">&nbsp;&nbsp;已是最后一页</a>';
				$pagetxt .= '<a href="javascript:;" title="已是最后一页">&nbsp;&nbsp;已是最后一页</a>';
			}
			$pagetxt .= '</div>';
		}
