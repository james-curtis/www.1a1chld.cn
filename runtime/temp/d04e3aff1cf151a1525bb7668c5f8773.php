<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"/www/wwwroot/rdyhue.shop/application/index/view/index/hezi.html";i:1560497734;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>欢迎进入，放心观赏.</title>
...
<body style="max-width:460px; margin:0 auto;">
       <div id="float_div_parent" style="display: flex; flex-direction: column; position: absolute; left: 0; right:0; top: 0; width: 250px; margin: auto;">
        <div id='float_div' style='width: 250px; height: 10px; text-align: center; top:0; position: relative; color: #FFF; font-size: 16px; padding: 5px 10px; transition: all 0.5s; '>来自广东的用户打赏3元</div> 
     </div>
     <script>
             ...
             <div class="video_img" style="padding-right: 10px;">
                <a href='{{d[i].dwz}}' >
                  <div style="position: relative; width: 100%; height: 100%;">
                    <img style="position: absolute; width: 25%; top: 30%; left: 37%;" src="/static/bf.png">
