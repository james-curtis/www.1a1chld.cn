<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/www/wwwroot/www.658166.vip/application/daili/view/gongyou/index.html";i:1558518726;s:69:"/www/wwwroot/www.658166.vip/application/daili/view/public/header.html";i:1551521020;s:69:"/www/wwwroot/www.658166.vip/application/daili/view/public/footer.html";i:1536907466;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
data: {id:id,guding:guding,title:title,start:start,end:end,issuiji:issuiji,isduoge:isduoge,type:type},
dataType:'json',
...
$('#shipinid').val($(this).attr('data-id'));
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("gongyou/index",['type'=>$typess]); ?>', {
            page: curr || 1,key:key
