<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/www/wwwroot/www.658166.vip/application/dsadmin/view/gongyou/add.html";i:1561294444;s:71:"/www/wwwroot/www.658166.vip/application/dsadmin/view/public/header.html";i:1550146424;s:71:"/www/wwwroot/www.658166.vip/application/dsadmin/view/public/footer.html";i:1550134066;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
  ...
  <option value ="<?php echo $vo['id']; ?>"><?php echo $vo['name']; ?></option>
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="add2" id="add2" method="post" action="add">
  ...
  <option value ="<?php echo $vo['id']; ?>"><?php echo $vo['name']; ?></option>
                        ...
                        <div class="form-group">
                            <div class="input-group col-sm-4">
                          <textarea rows="10" style="width: 100%;" class="form-control" placeholder="格式:视频地址|标题|主图地址 一行一个" name="txt" id="txt"></textarea>
                            </div>
                        </div>
