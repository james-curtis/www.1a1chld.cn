<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/www/wwwroot/ppds5di18.ink/application/dsadmin/view/type/add.html";i:1558454568;s:70:"/www/wwwroot/ppds5di18.ink/application/dsadmin/view/public/header.html";i:1550146424;s:70:"/www/wwwroot/ppds5di18.ink/application/dsadmin/view/public/footer.html";i:1550134066;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        function checkForm(){
            if( '' == $.trim($('#name').val())){
                layer.msg('名称不能为空', {icon: 5,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }
        ...
        function complete(data){
            if(data.code == 1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                    window.location.href="<?php echo url('type/index'); ?>";
                });
            }else{
