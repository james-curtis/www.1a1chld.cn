<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/www/wwwroot/www.658166.vip/application/dsadmin/view/zhifu/index.html";i:1559186352;s:71:"/www/wwwroot/www.658166.vip/application/dsadmin/view/public/header.html";i:1550146424;s:71:"/www/wwwroot/www.658166.vip/application/dsadmin/view/public/footer.html";i:1550134066;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php if(config("zfjk")==1): ?>微信<?php endif; if(config("zfjk")==2): ?>U<?php endif; if(config("zfjk")==3): ?>云<?php endif; if(config("zfjk")==5): ?>fastpay<?php endif; ?>支付设置</h5>
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal m-t" name="add" id="add" method="post" action="index">
                       ...
                       <?php endif; if(config("zfjk")==5): ?>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Appkey密钥：</label>
                            <div class="input-group col-sm-4">
                                <input id="fAppkey" type="text" class="form-control" name="fAppkey" placeholder="输入Appkey密钥" value="<?php if(!empty($content['fAppkey'])): ?><?php echo $content['fAppkey']; endif; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="fSECRET_KEY" type="text" class="form-control" name="fSECRET_KEY" placeholder="输入SECRET_KEY" value="<?php if(!empty($content['fSECRET_KEY'])): ?><?php echo $content['fSECRET_KEY']; endif; ?>">
                            </div>
                        </div>
                       <?php endif; ?>
                        <div class="hr-line-dashed"></div>
