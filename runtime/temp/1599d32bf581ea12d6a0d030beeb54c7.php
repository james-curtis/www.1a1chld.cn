<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/www/wwwroot/www.658166.vip/application/dsadmin/view/yqm/add_yqm.html";i:1536907466;s:71:"/www/wwwroot/www.658166.vip/application/dsadmin/view/public/header.html";i:1550146424;s:71:"/www/wwwroot/www.658166.vip/application/dsadmin/view/public/footer.html";i:1550134066;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add_yqm" id="add_yqm" method="post" action="<?php echo url('add_yqm'); ?>">
        ...
        function complete(data){
            if(data.code==1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    window.location.href="<?php echo url('yqm/index'); ?>";
                });
            }else{
