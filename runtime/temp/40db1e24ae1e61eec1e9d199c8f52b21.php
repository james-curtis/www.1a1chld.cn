<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/www/wwwroot/rdyhue.shop/application/daili/view/gonggao/read.html";i:1536907466;s:66:"/www/wwwroot/rdyhue.shop/application/daili/view/public/header.html";i:1551521020;s:66:"/www/wwwroot/rdyhue.shop/application/daili/view/public/footer.html";i:1536907466;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="<?php if($ismobile==0): ?>wrapper wrapper-content<?php endif; ?> animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5><?php echo $gonggao['title']; ?></h5>
        </div>
        <div class="ibox-content">
           <blockquote class="layui-elem-quote layui-quote-nm">
			<p></p><p><?php echo $gonggao['content']; ?><br></p><p></p>
			<p style="color:#999;">发布时间：<?php echo $gonggao['create_time']; ?></p>
			</blockquote>
