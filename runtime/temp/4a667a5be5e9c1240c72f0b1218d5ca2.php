<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"/www/wwwroot/www.658166.vip/application/daili/view/login.html";i:1563165722;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <title><?php echo config('WEB_SITE_TITLE'); ?>代理</title>
    <link href="__CSS__/bootstrap.min.css" rel="stylesheet">
    <link href="__CSS__/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="__CSS__/animate.min.css" rel="stylesheet">
    <link href="__CSS__/style.min.css" rel="stylesheet">
    <link href="__CSS__/login.min.css?v=1.1" rel="stylesheet">
    <!--极验验证需要引入的两个JS-->
    ...
    <div class="box">
        <div class="col-sm-5" style="color:#fff">
            <form id="doLogin" name="doLogin" method="post" action="<?php echo url('doLogin'); ?>">
                ...
                <p class="m-t-md"> <?php echo config('WEB_SITE_TITLE'); ?></p>
				...
				<?php if(config('user_allow_register')==1): ?>
				 <button type="button" class="btn btn-danger  btn-block" data-toggle="modal" data-target="#forget">注册账号</button>
				<?php endif; ?>
            </form>
        </div>
    </div>
