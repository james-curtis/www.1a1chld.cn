<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/www/wwwroot/317922.vip/application/dsadmin/view/kouliang/edit_kouliang.html";i:1536907466;s:67:"/www/wwwroot/317922.vip/application/dsadmin/view/public/header.html";i:1550146424;s:67:"/www/wwwroot/317922.vip/application/dsadmin/view/public/footer.html";i:1550134066;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="edit_kouliang" id="edit_kouliang" method="post" action="<?php echo url('edit_kouliang'); ?>">
                        <input type="hidden" name="id" value="<?php echo $kouliang['id']; ?>">
                            ...
                            <div class="input-group col-sm-4">
                                 <select class="form-control m-b chosen-select" name="userid" id="userid">
                                  ...
                                  <?php if(is_array($memberlist) || $memberlist instanceof \think\Collection || $memberlist instanceof \think\Paginator): $i = 0; $__LIST__ = $memberlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									  ...
									  <option value="<?php echo $vo['id']; ?>" <?php if($vo['id']==$kouliang['userid']): ?>selected<?php endif; ?>><?php echo $vo['nickname']; ?>(<?php echo $vo['id']; ?>)</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="cs" type="text" class="form-control" name="cs" placeholder="请输入初始值" value="<?php echo $kouliang['cs']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="ns" type="text" class="form-control" name="ns" placeholder="请输入倒数值" value="<?php echo $kouliang['ns']; ?>">
                            </div>
                        </div>
